        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">Form Tambah Jadwal {{ $paketTravel->nama_paket }}</h5>

                          <!-- Multi Columns Form -->
                          <form action="{{ route('admin.travel.store') }}" class="row g-3" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="paket_travel_id" value="{{ $paketTravel->id }}">
                            <div class="col-md-6">
                              <label for="inputName5" class="form-label">Tanggal Berangkat</label>
                              <input type="date" class="form-control" id="inputName5" name="tanggal_berangkat">
                            </div>
                            <div class="col-md-6">
                              <label for="inputEmail5" class="form-label">Tanggal Pulang</label>
                              <input type="date" class="form-control" id="inputEmail5" name="tanggal_pulang">
                            </div>
                            <div class="col-md-6">
                              <label for="inputPassword5" class="form-label">Kuota</label>
                              <input type="number" class="form-control" id="inputPassword5" name="kuota" placeholder="Kuota">
                            </div>
                            <div class="col-md-6">
                                <label for="inputPassword5" class="form-label">Harga</label>
                                <input type="number" class="form-control" id="inputPassword5" name="harga" placeholder="Harga">
                              </div>
                              <div class="col-md-12">
